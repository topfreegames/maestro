...
ROOM_PING_ENDPOINT = "{}/ping".format(ROOM_MGMT_ENDPOINT)
...
PING_INTERVAL_IN_SECONDS = int(os.environ.get("PING_INTERVAL_IN_SECONDS")) if os.environ.get("PING_INTERVAL_IN_SECONDS") else 5