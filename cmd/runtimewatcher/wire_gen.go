...
var WorkerOptionsSet = wire.NewSet(service.NewRuntimeKubernetes, RoomManagerSet,
	provideRuntimeWatcherConfig, wire.Struct(new(worker.WorkerOptions), "RoomManager", "Runtime"))
