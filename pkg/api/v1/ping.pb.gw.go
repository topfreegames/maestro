...
func RegisterPingHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PingServer) error {
	...
	mux.Handle("GET", pattern_Ping_GetPing_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v1.Ping/GetPing", runtime.WithHTTPPathPattern("/ping"))
		if err != nil {
...
func RegisterPingHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PingClient) error {
	...
	mux.Handle("GET", pattern_Ping_GetPing_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/api.v1.Ping/GetPing", runtime.WithHTTPPathPattern("/ping"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Ping_GetPing_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"ping"}, ""))
)
