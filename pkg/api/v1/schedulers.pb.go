...
var file_api_v1_schedulers_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6f, 0x6e, 0x32, 0xe5, 0x01, 0x0a, 0x11, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	...
	0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x73, 0x3a, 0x01, 0x2a, 0x42, 0x51, 0x0a, 0x23,
...
var file_api_v1_schedulers_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_v1_schedulers_proto_goTypes = []interface{}{
	...
	(*Scheduler)(nil),               // 4: api.v1.Scheduler
}
var file_api_v1_schedulers_proto_depIdxs = []int32{
	4, // 0: api.v1.ListSchedulersResponse.schedulers:type_name -> api.v1.Scheduler
	4, // 1: api.v1.CreateSchedulerResponse.scheduler:type_name -> api.v1.Scheduler
	0, // 2: api.v1.SchedulersService.ListSchedulers:input_type -> api.v1.ListSchedulersRequest
	3, // 3: api.v1.SchedulersService.CreateScheduler:input_type -> api.v1.CreateSchedulerRequest
	1, // 4: api.v1.SchedulersService.ListSchedulers:output_type -> api.v1.ListSchedulersResponse
	2, // 5: api.v1.SchedulersService.CreateScheduler:output_type -> api.v1.CreateSchedulerResponse
