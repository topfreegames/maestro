...
func (x *CreateSchedulerRequest) GetAnnotations() []*Annotation {
	if x != nil {
...
func (x *NewSchedulerVersionRequest) GetAnnotations() []*Annotation {
	if x != nil {
		return x.Annotations
	}
	return nil
...
var file_api_v1_schedulers_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x22, 0x8d, 0x03, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61,
	...
	0x73, 0x12, 0x34, 0x0a, 0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e,
	0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x61, 0x6e, 0x6e, 0x6f,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x61, 0x75, 0x74, 0x6f,
	...
	0x09, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x22, 0x91, 0x03, 0x0a, 0x1a, 0x4e,
	...
	0x72, 0x77, 0x61, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x34, 0x0a, 0x0b, 0x61, 0x6e, 0x6e, 0x6f,
	0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x0e,
	...
	0x22, 0x9f, 0x03, 0x0a, 0x15, 0x50, 0x61, 0x74, 0x63, 0x68, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75,
...
var file_api_v1_schedulers_proto_goTypes = []interface{}{
	...
	(*Annotation)(nil),                   // 24: api.v1.Annotation
	(*OptionalSpec)(nil),                 // 25: api.v1.OptionalSpec
	(*OptionalAutoscaling)(nil),          // 26: api.v1.OptionalAutoscaling
...
var file_api_v1_schedulers_proto_depIdxs = []int32{
	...
	24, // 6: api.v1.CreateSchedulerRequest.annotations:type_name -> api.v1.Annotation
	19, // 7: api.v1.GetSchedulerResponse.scheduler:type_name -> api.v1.Scheduler
	20, // 8: api.v1.NewSchedulerVersionRequest.spec:type_name -> api.v1.Spec
	21, // 9: api.v1.NewSchedulerVersionRequest.port_range:type_name -> api.v1.PortRange
	22, // 10: api.v1.NewSchedulerVersionRequest.autoscaling:type_name -> api.v1.Autoscaling
	23, // 11: api.v1.NewSchedulerVersionRequest.forwarders:type_name -> api.v1.Forwarder
	24, // 12: api.v1.NewSchedulerVersionRequest.annotations:type_name -> api.v1.Annotation
	25, // 13: api.v1.PatchSchedulerRequest.spec:type_name -> api.v1.OptionalSpec
	21, // 14: api.v1.PatchSchedulerRequest.port_range:type_name -> api.v1.PortRange
	26, // 15: api.v1.PatchSchedulerRequest.autoscaling:type_name -> api.v1.OptionalAutoscaling
	23, // 16: api.v1.PatchSchedulerRequest.forwarders:type_name -> api.v1.Forwarder
	27, // 17: api.v1.GetSchedulerVersionsResponse.versions:type_name -> api.v1.SchedulerVersion
	28, // 18: api.v1.GetSchedulersInfoResponse.schedulers:type_name -> api.v1.SchedulerInfo
	29, // 19: api.v1.validator:extendee -> google.protobuf.FieldOptions
