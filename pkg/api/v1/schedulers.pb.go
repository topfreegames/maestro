...
var file_api_v1_schedulers_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x08, 0x68, 0x6f, 0x73, 0x74, 0x50, 0x6f, 0x72, 0x74, 0x32, 0xe5, 0x01, 0x0a, 0x11,
	...
	0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x73, 0x12, 0x6a, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x93, 0x02, 0x10, 0x22, 0x0b, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x73,
	0x3a, 0x01, 0x2a, 0x42, 0x51, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x6f, 0x70, 0x66, 0x72,
...
var file_api_v1_schedulers_proto_goTypes = []interface{}{
	...
	(*Scheduler)(nil),               // 8: api.v1.Scheduler
	(*PortRange)(nil),               // 9: api.v1.PortRange
}
var file_api_v1_schedulers_proto_depIdxs = []int32{
	8,  // 0: api.v1.ListSchedulersResponse.schedulers:type_name -> api.v1.Scheduler
	8,  // 1: api.v1.CreateSchedulerResponse.scheduler:type_name -> api.v1.Scheduler
	4,  // 2: api.v1.CreateSchedulerRequest.containers:type_name -> api.v1.Container
	9,  // 3: api.v1.CreateSchedulerRequest.port_range:type_name -> api.v1.PortRange
	...
	2,  // 11: api.v1.SchedulersService.CreateScheduler:output_type -> api.v1.CreateSchedulerResponse
