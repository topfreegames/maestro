...
var file_api_v1_schedulers_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x73, 0x32, 0xe2, 0x06, 0x0a, 0x11, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	...
	0x7d, 0x3a, 0x01, 0x2a, 0x12, 0x92, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65,
	0x64, 0x75, 0x6c, 0x65, 0x72, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x23, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75,
	...
	0x12, 0x27, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x73,
	0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x3d, 0x2a, 0x7d,
	0x2f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x51, 0x0a, 0x23, 0x63, 0x6f, 0x6d,
...
var file_api_v1_schedulers_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_api_v1_schedulers_proto_goTypes = []interface{}{
	...
	(*SchedulerWithoutSpec)(nil),         // 14: api.v1.SchedulerWithoutSpec
	(*Scheduler)(nil),                    // 15: api.v1.Scheduler
	(*Container)(nil),                    // 16: api.v1.Container
	(*PortRange)(nil),                    // 17: api.v1.PortRange
	(*Forwarder)(nil),                    // 18: api.v1.Forwarder
	(*SchedulerVersion)(nil),             // 19: api.v1.SchedulerVersion
}
var file_api_v1_schedulers_proto_depIdxs = []int32{
	14, // 0: api.v1.ListSchedulersResponse.schedulers:type_name -> api.v1.SchedulerWithoutSpec
	15, // 1: api.v1.CreateSchedulerResponse.scheduler:type_name -> api.v1.Scheduler
	16, // 2: api.v1.CreateSchedulerRequest.containers:type_name -> api.v1.Container
	17, // 3: api.v1.CreateSchedulerRequest.port_range:type_name -> api.v1.PortRange
	18, // 4: api.v1.CreateSchedulerRequest.forwarders:type_name -> api.v1.Forwarder
	15, // 5: api.v1.GetSchedulerResponse.scheduler:type_name -> api.v1.Scheduler
	16, // 6: api.v1.NewSchedulerVersionRequest.containers:type_name -> api.v1.Container
	17, // 7: api.v1.NewSchedulerVersionRequest.port_range:type_name -> api.v1.PortRange
	18, // 8: api.v1.NewSchedulerVersionRequest.forwarders:type_name -> api.v1.Forwarder
	19, // 9: api.v1.GetSchedulerVersionsResponse.versions:type_name -> api.v1.SchedulerVersion
	...
	1,  // 17: api.v1.SchedulersService.ListSchedulers:output_type -> api.v1.ListSchedulersResponse
	9,  // 18: api.v1.SchedulersService.GetScheduler:output_type -> api.v1.GetSchedulerResponse
	2,  // 19: api.v1.SchedulersService.CreateScheduler:output_type -> api.v1.CreateSchedulerResponse
	5,  // 20: api.v1.SchedulersService.AddRooms:output_type -> api.v1.AddRoomsResponse
	7,  // 21: api.v1.SchedulersService.RemoveRooms:output_type -> api.v1.RemoveRoomsResponse
	11, // 22: api.v1.SchedulersService.NewSchedulerVersion:output_type -> api.v1.NewSchedulerVersionResponse
	13, // 23: api.v1.SchedulersService.GetSchedulerVersions:output_type -> api.v1.GetSchedulerVersionsResponse
