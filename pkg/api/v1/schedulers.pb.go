...
var file_api_v1_schedulers_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x61, 0x78, 0x53, 0x75, 0x72, 0x67, 0x65, 0x22, 0x50, 0x0a,
	...
	0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x32, 0xcc, 0x04, 0x0a, 0x11, 0x53, 0x63, 0x68, 0x65, 0x64,
	...
	0x6d, 0x73, 0x3a, 0x01, 0x2a, 0x42, 0x51, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x6f, 0x70,
...
var file_api_v1_schedulers_proto_goTypes = []interface{}{
	...
	(*Container)(nil),               // 11: api.v1.Container
	(*PortRange)(nil),               // 12: api.v1.PortRange
}
var file_api_v1_schedulers_proto_depIdxs = []int32{
	...
	11, // 2: api.v1.CreateSchedulerRequest.containers:type_name -> api.v1.Container
	12, // 3: api.v1.CreateSchedulerRequest.port_range:type_name -> api.v1.PortRange
	10, // 4: api.v1.GetSchedulerResponse.scheduler:type_name -> api.v1.Scheduler
