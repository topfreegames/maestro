...
var file_api_v1_operations_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x98, 0x01, 0x0a, 0x11, 0x4f, 0x70, 0x65, 0x72,
...
var file_api_v1_operations_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_api_v1_operations_proto_depIdxs = []int32{
	2, // 0: api.v1.ListOperationsResponse.pending_operations:type_name -> api.v1.Operation
	2, // 1: api.v1.ListOperationsResponse.active_operations:type_name -> api.v1.Operation
	2, // 2: api.v1.ListOperationsResponse.finished_operations:type_name -> api.v1.Operation
	0, // 3: api.v1.OperationsService.ListOperations:input_type -> api.v1.ListOperationsRequest
	1, // 4: api.v1.OperationsService.ListOperations:output_type -> api.v1.ListOperationsResponse
